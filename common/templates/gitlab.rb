...
gitlab_rails['gitlab_email_reply_to'] = 'gitlab@'
...
####!   "user" part of the address (before the `@`).**
 gitlab_rails['incoming_email_address'] = "gitlab@"
...
# gitlab_rails['omniauth_auto_sign_in_with_provider'] = 'saml'
 ...
 gitlab_rails['omniauth_providers'] = [
   {
     "name" => "shibboleth",
     "label" => "Incommon Federation",
     "args" => { 
	     "shib_session_id_field" => "HTTP_SHIB_SESSION_ID", 
	     "shib_application_id_field" => "HTTP_SHIB_APPLICATION_ID",
             #"uid_field" => "HTTP_UUPID",
             "uid_field" => "HTTP_EPPN",
             "name_field" => "HTTP_DISPLAYNAME",
             "info_fields" => { "email" => "HTTP_EPPN"}
     }
   }
 ]
...
#    }
# })
git_data_dirs({ "default" => { "path" => "/apps/git-data", 'gitaly_address' => 'unix:/var/opt/gitlab/gitaly/gitaly.socket' } })
